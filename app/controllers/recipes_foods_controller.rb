class RecipesFoodsController < ApplicationController
  before_action :set_recipes_food, only: [:show, :edit, :update, :destroy]

  # GET /recipes_foods
  # GET /recipes_foods.json
  def index
    @recipes_foods = RecipesFood.all
  end

  # GET /recipes_foods/1
  # GET /recipes_foods/1.json
  def show
  end
  ...
  # PATCH/PUT /recipes_foods/1
  # PATCH/PUT /recipes_foods/1.json
  def update
    respond_to do |format|
