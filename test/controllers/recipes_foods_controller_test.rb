...
class RecipesFoodsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create recipes_food" do
    assert_difference('RecipesFood.count') do
      post recipes_foods_url, params: { recipes_food: { food_id: @recipes_food.food_id, recipe_id: @recipes_food.recipe_id } }
    end
  ...
  test "should update recipes_food" do
    patch recipes_food_url(@recipes_food), params: { recipes_food: { food_id: @recipes_food.food_id, recipe_id: @recipes_food.recipe_id } }
